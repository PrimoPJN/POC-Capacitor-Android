...
module.exports = __webpack_require__(/*! C:\PIONEER\capacitor\poc-capacitor\poc-capacitor\src\main.ts */"zUnb");
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
  ...
  decls: 9,
  vars: 6,
  consts: [[1, "load", 2, "background-color", "#CC0000", "height", "100vh", "display", "grid", "grid-row", "1", "align-items", "center"], [1, "col"], [1, "fast-checkout-icon", "text-center"], ["src", "./assets/close.svg", "alt", "Logo fast checkout", 1, "fast-checkout-logo-branco"]],
